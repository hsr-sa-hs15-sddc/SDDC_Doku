...
\begin{itemize}
  ...
  \item Plugins über Dashboard installieren (Admin)
\end{itemize}
\subsection{Lieferumfang}
\begin{itemize}
  \item Source-Code (Dashboard/API)
  \item Dokumentation (Projekt und Software)
  \item Benutzerdokumentation (HowTo)
\end{itemize}
...
abonniert werden + API erweitern (für nicht unterstützte Anbieter) & 05.10.15 & 19.10.15 \\
\hline
