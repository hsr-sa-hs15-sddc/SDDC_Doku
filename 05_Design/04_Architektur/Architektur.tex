...
\textbf{05.12.15} & 1.10 & Services erweitert & Silvan Adrian\\
\textbf{06.12.15} & 1.11 & GenericAPI + Dependency Injection & Fabian Binna\\
\textbf{06.12.15} & 1.12 & Squenzdiagramm auf neue GenericAPI angepasst & Fabian Binna\\
\end{tabularx}
...
\includegraphics[width=\textwidth]{genericapi}
...
\begin{center}
\includegraphics[width=\textwidth]{orderService}
\end{center}
