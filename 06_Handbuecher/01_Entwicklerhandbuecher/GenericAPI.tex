...
\end{lstlisting}
Im Konstruktor wird die Klasse Connect weitergegeben und die Kategory des 
...
also komplett anders ausfallen. Wichtig ist hier, dass die Connect Klasse mit test:///default 
